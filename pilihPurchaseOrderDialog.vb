...
Public Class pilihPurchaseOrderDialog
    ...
    Public Sub New()
        ...
        Dim sql As String = "select nota, nama from po_header"
        Try
    ...
    Private Sub dgv_pilihpoheader_changeselected(sender As Object, e As EventArgs) Handles dgv_pilihpoheader.SelectionChanged
    ...
    Private Sub tb_nomorPO_textChanged(sender As Object, e As EventArgs) Handles tb_nomorPO.TextChanged
        ...
        Try
            Dim quer As String = "select nota, nama from po_header where nota like '%" & tb_nomorPO.Text & "%'"
